...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.ActiveOrganizationID = field.NewString(tableName, "active_organization_id")
...
func (s *session) updateTableName(table string) *session {
	...
	s.ActiveOrganizationID = field.NewString(table, "active_organization_id")
...
func (s *session) fillFieldMap() {
	...
	s.fieldMap["active_organization_id"] = s.ActiveOrganizationID
